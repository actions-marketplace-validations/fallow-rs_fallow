...
- `plugins/` — Plugin system: `Plugin` trait, registry (90 built-in, ~38 with AST-based config parsing), `config_parser.rs` (Oxc-based helpers), `tooling.rs` (general tooling dep detection)
